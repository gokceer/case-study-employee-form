    ...
    return html`
      <div class="container">
        ...
        <div class="right-part">
          ...
          >
            ${localization.getTranslation('employees')}
          </button>

          <button
            class=${window.location.pathname === '/create' ? 'active' : ''}
            @click=${this.onNewEmployeeClick}
          >
            ${localization.getTranslation('addNew')}
          </button>
          <button @click="${() => this.toggleLanguage('tr')}">
            <svg
          ...
          <button @click="${() => this.toggleLanguage('en')}">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
